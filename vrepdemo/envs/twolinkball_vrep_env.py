...
class TwoLinkBallVrepEnv(vrep_env.VrepEnv):
    ...
    def __init__(
            ...
            server_port=19997,
            scene_path=vrep_scenes_path+'/twolinkball.ttt',
                 ):
        ...
        self.joints_max_velocity = 70*np.pi/180  # 第二个关节期望0.04rad/s，也就是2.29°
        self.power = 5
