...
class SixLink1VrepEnv(vrep_env.VrepEnv):
    ...
    def __init__(
            ...
            server_port=19997,
            scene_path=vrep_scenes_path+'/UR1.ttt',
                 ):
        ...
        self.power = np.array([10, 100, 100, 10, 50, 10])
    ...
    def step(self, action):
        ...
        # y_lim = [0.7285-0.05, 0.7285+0.05]
        z_lim = [0.46-0.05, 0.46+0.01]
        done1 = (y > target_y) and (ez < 2)
        done2 = (z < z_lim[0]) or (z > z_lim[1]) or (x < x_lim[0]) or (x > x_lim[1])  # 只能沿着x轴的方向走
